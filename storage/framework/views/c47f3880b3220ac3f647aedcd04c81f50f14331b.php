...
<div class="alert alert-danger d-none messageBox" id='caixinha' role="alert">
      ...
      <form name="FormBuscar" action=" <?php echo e(route('buscar')); ?>"  method="POST">
<?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\laravel-crud\crud_basico\resources\views/produtos/main.blade.php ENDPATH**/ ?>